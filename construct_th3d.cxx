...
int main(int argc, char **argv) {
  ...
  hist_list.emplace_back(construct_hist(
      df_all.Filter([](double proton_p) { return proton_p < 0.25; },
                    {"raw_proton_momentum"}),
      "E_lepton_vs_E_pi0_vs_cos_theta_lepton_pi0_peak_region"));
  hist_list.emplace_back(construct_hist(
      df_all.Filter([](double proton_p) { return proton_p >= 0.25; },
                    {"raw_proton_momentum"}),
      "E_lepton_vs_E_pi0_vs_cos_theta_lepton_pi0_tail_region"));
  ...
  hist_list.emplace_back(construct_hist(
      df_all
          ...
          .Filter(
              [](const NeutrinoEvent &event) { return event.is_transparent(); },
              {"EventRecord"}),
      "E_lepton_vs_E_pi0_vs_cos_theta_lepton_pi0_peak_region_transparent"));
  hist_list.emplace_back(construct_hist(
      df_all
          .Filter([](double proton_p) { return proton_p >= 0.25; },
                  {"raw_proton_momentum"})
